...
if (productId) {
    ...
    <div class="product-info-wrapper" style="display: flex; gap: 40px; align-items: flex-start; padding: 20px;">
        ...
        <div class="product-details-box" style="flex: 1;">
            ...
            <div class="product-rating" style="color: #ffc107; margin-bottom: 15px; font-size: 1.1rem; display: flex; align-items: center; gap: 5px;">
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star"></i>
                <i class="fa-solid fa-star-half-stroke"></i>
                <span style="color: #888; font-size: 0.9rem; margin-left: 5px;">(4.8 Out of 5)</span>
            </div>
